...
//console.log('width=',$('.carousel-inner').width(),' height=',$('.carousel-inner').height());

$(".dots-container").prepend(tela);
tela.width = $(window).width();
tela.height = $(window).height();
function resize(){
    $('canvas').outerHeight($(window).height()-$('canvas').offset().top- Math.abs($('canvas').outerHeight(true) - $('canvas').outerHeight()));
    $('canvas').outerWidth($(window).width()-$('canvas').offset().left- Math.abs($('canvas').outerWidth(true) - $('canvas').outerWidth()));
